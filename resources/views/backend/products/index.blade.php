...
<main class="container-fluid mt--8">
    <div class="row align-items-center py-4">
        ...
        <div class="col-lg-6 col-5 text-right">
            <a href="{{route('backend.products.getform')}}" class="btn btn-dark m-b-sm btn-add pull-right">
...
<script>
    ...
    var form = "{{ route('backend.products.getform') }}";
    var crud = new Crud({
        filter: true,
        list: {
            url: "{{route('backend.products.data')}}",
            datatable: {
                columns: [
                {data: 'id', name: 'id'},
                {data: 'type', name: 'type'},
