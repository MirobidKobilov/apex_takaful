        ...
        <div class="col-lg-6 col-7">
            <nav aria-label="breadcrumb" class="d-none d-md-inline-block ml-md-4">
                <ol class="breadcrumb breadcrumb-links breadcrumb-dark">
                    <li class="breadcrumb-item"><a href="#">Работники</a></li>
                </ol>
            </nav>
        </div>
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="ru" role="tabpanel" aria-labelledby="ru-tab">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="job_ru" class="col-form-label form-control-label">Должность (RU)</label>
                        ...
                        <div class="tab-pane fade" id="uz" role="tabpanel" aria-labelledby="uz-tab">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="job_uz" class="col-form-label form-control-label">Должность (UZ)</label>
                        ...
                        <div class="tab-pane fade" id="en" role="tabpanel" aria-labelledby="en-tab">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <label for="job_en" class="col-form-label form-control-label">Должность (EN)</label>
...
<script>
  var crud = new Crud({
    filter: true,
    form: {
      url: "{{ route('backend.staffs.form') }}",
    },

    list: {
      url: "{{route('backend.staffs.data')}}",
      datatable: {            
        columns: [
          {data: 'id', name: 'id'},
          {data: 'name', name: 'name'},
    ...
    remove: {
      url: "{{ route('backend.staffs.delete') }}",
    }
  })
</script>
@endsection